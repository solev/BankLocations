(function () {
    ...
    angular
        .module('app')
        .directive('canvasGrid', canvasGrid);

    canvasGrid.$inject = ['$window'];

    function canvasGrid($window) {
        // Usage:
        ...
        function link(scope, element, attrs) {
            ...
            cnvs.width = parent.width();
            cnvs.height = parent.height();
            ...
            function drawGrid() {
                ...
                var canvas_width = cnvs.width;

                // canvas height
                var canvas_height = cnvs.height;
